...
input_path = r"C:\Users\czw17\Desktop\扰动信号数据4.csv"
...
plt.subplot(4, 1, 2)
plt.plot(x_values, first_derivative, label='一阶导数', color='orange')
plt.legend()
plt.title('一阶导数')
...
plt.subplot(4, 1, 4)
plt.plot(x_values, second_derivative, label='二阶导数', color='green')
plt.plot(x_values, second_derivative_symmetric, label='关于x轴的对称', color='red', linestyle='--')
plt.legend()
